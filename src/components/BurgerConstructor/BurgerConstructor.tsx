...
const BurgerConstructor: FC = () => {
  ...
  const orderNumber = useSelector((state) => selectOrderNumber(state));
  const bun = useSelector((state) => state.constructorList.bun) as Ingredient;
  const card = useSelector((state) => state.constructorList.ingredients) as Ingredient[];
