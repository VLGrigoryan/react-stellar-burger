    ...
    <header className={`${AHStyles.header} pt-4 pb-4`}>
      <nav className={AHStyles.nav}>
        <div className={`${AHStyles.list} mr-28`}>
          ...
          >
            <BurgerIcon type={location.pathname === "/" ? "active" : "secondary"} />
            <span
              className={`text ${
                location.pathname === "/" ? "text_color_active" : "text_color_inactive"
          ...
          >
            <ListIcon type={location.pathname === "/orders" ? "active" : "secondary"} />
            <span
              className={`text ${
                location.pathname === "/orders" ? "text_color_active" : "text_color_inactive"
              } text_type_main-default ml-2`}
            >
              Лента заказов
            </span>
        ...
        <div className={`${AHStyles.list} ${AHStyles.rightList}`}>
          ...
          >
            <ProfileIcon type={["/profile", "/login", "/forgot-password", "/reset-password", "/register"].includes(location.pathname) ? "active" : "secondary"} />
            <span
              className={`text ${
                ["/profile", "/login", "/forgot-password", "/reset-password", "/register"].includes(location.pathname) ? "text_color_active" : "text_color_inactive"
              } text_type_main-default ml-2`}
            >
              Личный кабинет
            </span>
